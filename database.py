...
class SystemMetrics(Base):
    ...
    # Additional data - FIXED: Changed from 'metadata' to 'additional_metadata'
...
class AuditLog(Base):
    ...
    # Additional data - FIXED: Changed from 'additional_data' to 'extra_data' to be more descriptive
...
def record_metric(db: SessionLocal, metric_name: str, value: float, metric_type: str, **kwargs):
    """Record system metric - FIXED to handle metadata parameter"""
    try:
